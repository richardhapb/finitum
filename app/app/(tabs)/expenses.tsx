    ...
    <View className="bg-gray-800 mx-4 mb-3 rounded-xl p-4">
      <View className="flex-row justify-between items-start">
        <View className="flex-1 mr-4">
          <Text className="text-white font-semibold text-base">{item.commerce}</Text>
          <View className="flex-row items-center mt-1">
            ...
            <Text className="text-gray-500 text-xs ml-2">{formatDate(item.date)}</Text>
          </View>
          {item.description && (
      ...
      <View className="px-4 pt-4 pb-2">
        ...
        {selectedCategory && (
          <View className="flex-row items-center mt-2">
            <Text className="text-gray-400 text-sm">Filtered by: </Text>
            <TouchableOpacity
            ...
            <TouchableOpacity activeOpacity={1}>
              <View className="bg-gray-800 rounded-t-3xl max-h-[70%]">
                <View className="flex-row justify-between items-center p-4 border-b border-gray-700">
                  <Text className="text-white text-lg font-semibold">Filter by Category</Text>
                ...
                <ScrollView className="p-4">
                  <TouchableOpacity
                    className={`p-4 rounded-lg mb-2 ${
                      selectedCategory === null ? "bg-blue-600" : "bg-gray-700"
                    }`}
                    onPress={() => {
                  ...
                  >
                    <Text className="text-white font-medium">All Categories</Text>
                  </TouchableOpacity>
